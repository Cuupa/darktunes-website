      ...
      <div className="text-center max-w-md space-y-6">
        {isError ? (
          <>
            ...
            <h1 className="text-3xl font-bold tracking-tight uppercase">{t.confirmErrorTitle}</h1>
            <p className="text-muted-foreground">{t.confirmErrorMessage}</p>
          </>
        ) : (
          <>
            <CheckCircle size={64} weight="fill" className="text-primary mx-auto" />
            <h1 className="text-3xl font-bold tracking-tight uppercase">{t.confirmSuccessTitle}</h1>
            <p className="text-muted-foreground">{t.confirmSuccessMessage}</p>
          </>
        )}
        <Link
          href="/"

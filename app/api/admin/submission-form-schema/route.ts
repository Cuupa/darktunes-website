...
const typeFieldRuleSchema = z.object({
  visible: z.boolean(),
  required: z.boolean(),
})

const typeRulesSchema = z.partialRecord(
  z.enum(SUBMISSION_RELEASE_TYPES),
  typeFieldRuleSchema,
)
...
const upsertSchema = z.object({
  ...
  type_rules: typeRulesSchema.nullable().optional(),
...
export const PUT = withErrorHandler(async (req: NextRequest) => {
  ...
  const field = await upsertFormField(supabase, {
    ...
    type_rules: body.type_rules ?? null,

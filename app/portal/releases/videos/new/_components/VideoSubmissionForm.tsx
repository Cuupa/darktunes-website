...
export function VideoSubmissionForm({ dict }: VideoSubmissionFormProps) {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!session) {
        toast.error(dict.video_submit_error)
        return
      }
      ...
      toast.success(dict.video_submit_success)
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold">{dict.video_submit_heading}</h1>

      <Card className="bg-card border-border">
        <CardHeader>
          <CardTitle>{dict.video_submit_heading}</CardTitle>
        </CardHeader>
        <CardContent>
          <form className="space-y-4" onSubmit={(e) => void submit(e)}>
            <div className="space-y-2">
              <Label htmlFor="video-title">
                {dict.video_submit_title}
            ...
            <div className="space-y-2">
              <Label htmlFor="download-url">
                {dict.video_submit_download_url}
                <span className="text-destructive ml-1">*</span>
              </Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="yt-description">
                {dict.video_submit_yt_description}
                <span className="text-destructive ml-1">*</span>
              </Label>

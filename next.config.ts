        ...
        headers: [
          ...
          { key: 'Referrer-Policy', value: 'strict-origin-when-cross-origin' },
          {
            ...
            value: [
              ...
              "connect-src 'self' data: blob: https://*.supabase.co wss://*.supabase.co https://*.r2.dev https://wsrv.nl https://fonts.googleapis.com https://fonts.gstatic.com https://darkmerch.com",

    ...
    <section id="releases" className="py-24 px-4 lg:px-16">
      <div className="container mx-auto">
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-5xl lg:text-6xl font-bold mb-4 tracking-tight">RELEASES</h2>
          <p className="text-xl text-muted-foreground font-serif">Discover the latest music from our roster</p>
        </motion.div>

...
/**
 * NewsletterSection — embeds the darkmerch.com newsletter sign-up form via
 * an iframe, wrapped in the site's standard dark-industrial visual treatment.
 *
 * The iframe is served from darkmerch.com (Shopify) and handles subscription
 * logic externally. We inject a postMessage-based CSS override via onLoad so
 * the form background and text colours blend with the darkTunes dark theme.
 */

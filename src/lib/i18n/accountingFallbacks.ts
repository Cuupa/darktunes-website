...
export const ACCOUNTING_FALLBACK = {
  ...
  subTabUpload: 'Files',
  subTabReporting: 'Amounts',
  subTabSettlements: 'Statements',
  subTabAnalytics: 'Insights',
  subTabAnalyticsHint:
    'Archives, portal persist, listener sync, and trends — not part of the billing path.',
  subTabSettlementsHint:
    'Create drafts, approve statements, record payments, and export SEPA.',
  ...
  emptySettlements: 'Set a billing period on Files to open statements and SEPA.',
  ...
  workspaceSaveFailed: 'Workspace was not saved. Latest edits may exist only in this browser — click Save and retry.',
  workspaceSaveError: 'Workspace was not saved. Check the network, then click Save.',
  workspaceDefaultSaveError: 'Default rules were not saved. Check the network, then retry Save default preset.',
  workspaceLoadFailed: 'Workspace could not be loaded from the server. You may be seeing stale local rules — click Reload from server.',
  ...
  guidedReviewHint: 'Check artist amounts, then continue to statements.',
  ...
  payoutBreakdownPayout: 'Period payout',
  payoutBreakdownOpening: 'Opening',
  payoutBreakdownDue: 'Amount due',
  payoutOriginArtistSource: 'artist source rule',
  payoutOriginGlobalSource: 'label source default',
  payoutOriginArtistDigital: 'artist digital split',
  payoutOriginArtistPhysical: 'artist physical split',
  payoutOriginDefaultDigital: 'label digital default',
  payoutOriginDefaultPhysical: 'label physical default',
  payoutOriginArtist: 'artist split',
  payoutOriginDefault: 'label default',
  ...
  csvProcessingError: 'The sales file could not be processed',
  workerCrashed: 'Processing stopped unexpectedly. Re-upload the files. If it happens again, reload the page.',
  workerCrashedUnknown: 'The worker did not say why it stopped. Reload the page and re-upload the files.',
  ...SOS_ERROR_FALLBACK,
  analyticsPersistFailed: 'Portal analytics were not saved. Statements can still be created — retry Save to Portal.',
  presetSaveSuccess: 'Preset "{name}" saved (durable rules only, not this period’s recoup lines).',
  presetSaveFailed: 'The rule preset was not saved. Check the name and network, then retry.',
  presetDeleted: 'Preset deleted.',
  presetDeleteFailed: 'The preset was not deleted. Reload Rules and retry.',
  exportNoSelectedArtists: 'No processed amounts match the selected artists. Process the CSVs first, then select artists that appear on Amounts.',
  exportPublishFailed: 'The statement draft was not created.',
  excelFallbackTitle: 'Original reports could not be built',
  excelFallbackRetry: 'Retry',
  excelFallbackSummaryOnly: 'Download summary only',
  excelFallbackCancel: 'Cancel',
...
export const SETTLEMENT_FALLBACK = {
  ...
  settlementInvoiceDeliveryFailed: 'Email failed',
  ...
  settlementRegisterLoadFailed: 'Statement register could not be loaded. Invoice and payment status may be missing — reload.',
  settlementRegisterRetry: 'Reload',
  ...
  settlementPdfBtn: 'PDF',
  settlementPdfAria: 'Download statement PDF for {artist}',
  settlementPdfFailed: 'The statement PDF could not be opened. The file may be missing in storage — retry, or recreate the draft.',
  settlementNotifyBtn: 'Retry notify',
  settlementNotifyAria: 'Retry artist notification for {artist}',
  settlementNotifySent: 'Notification sent to {artist}',
  settlementNotifyFailed: 'Could not notify the artist. Statement stays approved — retry when mail works.',
